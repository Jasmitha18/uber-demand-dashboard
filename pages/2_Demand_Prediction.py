...
st.subheader("Predict Ride Demand using Machine Learning")
...
if st.button(" Predict Demand"):
    ...
    input_data = np.array([[day, hour, weekday]])
    ...
    if level == "High":
        st.success(
            "High ride demand expected."
        )

    elif level == "Medium":
        st.warning(
            "Moderate ride demand expected."
        )

    else:
        st.info(
            "Low ride demand expected."
        )
